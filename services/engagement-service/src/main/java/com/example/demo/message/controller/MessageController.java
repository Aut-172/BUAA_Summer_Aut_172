...
public class MessageController {
    ...
    public MessageController(MessageService messageService, OrderClient orderClient) {
    ...
    public Result<OrderClient.OrderSnapshot> getConversationOrder(@PathVariable Long orderId,
                                                                  HttpServletRequest httpRequest) {
        Long userId = (Long) httpRequest.getAttribute("userId");
        String role = (String) httpRequest.getAttribute("role");
        if (userId == null || role == null) {
        ...
        String userType = mapRoleToType(role);
        return Result.success(orderClient.getParticipantOrder(orderId, userId, userType));
    }
